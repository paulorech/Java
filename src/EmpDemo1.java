...
public static void main(String[] args) {
	...
	Employeee[] empArray  = new Employeee[10];
	...
	empArray[i] = new Employeee(empId, salary);
	...
	//sort by Id
   public static void sortById(Employeee[] array) {
   ...
   //sort by Salary
   public static void sortBySalary(Employeee[] array) {
		int comparison = array.length-1;
		for(int a = 0 ; a < array.length-1 ; a++) {
			for(int b = 0 ; b < comparison ; b++) {
